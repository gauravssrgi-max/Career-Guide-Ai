    ...
    <div style={styles.page}>
      ...
      <div style={styles.card}>
        ...
        <div style={{display:'flex', flexDirection:'column', gap: 10, marginBottom: 20}}>
          ...
          <button className="btn" style={styles.githubBtn} onClick={handleGitHubLogin}>
...
const styles = {
  ...
  githubBtn: { width: '100%', background: '#24292e', color: '#fff', border: '1px solid #444', borderRadius: 'var(--radius-md)', padding: '12px 20px', fontSize: '0.9rem', fontWeight: 500, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10, cursor: 'pointer', transition: 'all 0.2s' },
